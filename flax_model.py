  ...
  def __call__(self, graphs: jraph.GraphsTuple) -> jraph.GraphsTuple:
    ...
    for _ in range(self.message_passing_steps):
      ...
      if self.skip_connections:
        # print("SIZE FEATS", processed_graphs)
        # print("SIZE FEATS 1", graph_net)
        # print("SIZE FEATS 2::", graph_net(processed_graphs).edges.shape)
    ...
    # Since our graph-level predictions will be at edges, we will
    # decode to get the required output logits.
    decoder = jraph.GraphMapFeatures(
        embed_edge_fn=nn.Dense(self.output_size))
