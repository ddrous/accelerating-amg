...
from model import to_prolongation_matrix_tensor, to_prolongation_matrix_csr, \
                dgl_graph_to_sparse_matrices, AMGDataset
...
def model(A, coarse_nodes, baseline_P, C, graph_model, normalize_rows=True, normalize_rows_by_node=False):
    ...
    P_csr, _ = to_prolongation_matrix_csr(P_square_sparse, coarse_nodes, baseline_P, nodes,
                                                normalize_rows=normalize_rows,
                                                normalize_rows_by_node=normalize_rows_by_node)
