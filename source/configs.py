...
class TrainConfig:
    def __init__(self, samples_per_run=2560, num_runs=10, batch_size=32, learning_rate=1e-3, fourier=False,
...
GRAPH_LAPLACIAN_TEST.test_config.test_sizes = (8192, 16384)
